========================================================================
		ActiveX Control DLL : CTWDAN
========================================================================

ControlWizard has created this project for your CTWDAN ActiveX Control
...
that make up your CTWDAN ActiveX Control DLL.
...
CTwLcDanCtl.h
	This file contains the declaration of the CCTwLcDanCtrl C++ class.

CTwLcDanCtl.cpp
	This file contains the implementation of the CCTwLcDanCtrl C++ class.

CTwLcDanPpg.h
	This file contains the declaration of the CCTwLcDanPropPage C++ class.

CTwLcDanPpg.cpp
	This file contains the implementation of the CCTwLcDanPropPage C++ class.

CTwLcDanCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCTwLcDanCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CTwDan.rc.

/////////////////////////////////////////////////////////////////////////////
CSsTwDan control:

CSsTwDanCtl.h
	This file contains the declaration of the CCSsTwDanCtrl C++ class.

CSsTwDanCtl.cpp
	This file contains the implementation of the CCSsTwDanCtrl C++ class.

CSsTwDanPpg.h
	This file contains the declaration of the CCSsTwDanPropPage C++ class.

CSsTwDanPpg.cpp
	This file contains the implementation of the CCSsTwDanPropPage C++ class.

CSsTwDanCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCSsTwDanCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CTwDan.rc.
